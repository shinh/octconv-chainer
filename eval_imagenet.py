...
models = {
    ...
    'octresnet50': (OctResNet50, {}, 32, 'center', 'fb'),
...
def setup(dataset, model, pretrained_model, batchsize, val, crop, resnet_arch, alpha):
...
def main():
    ...
    dataset, eval_, model, batchsize = setup(
        ...
        args.val, args.crop, args.resnet_arch, args.alpha)
